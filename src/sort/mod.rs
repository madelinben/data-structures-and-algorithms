...
//! 
//! This module provides comprehensive sorting algorithm implementations with performance analysis.
//! It generates random arrays and benchmarks different sorting strategies with Big O analysis.
...
pub struct SortMetrics {
    ...
    pub actual_time_ratio: f64, // Actual time vs theoretical
...
/// Comparison and swap counter for tracking algorithm performance
...
/// Main sorting algorithm coordinator
pub struct SortCoordinator {
    /// Performance metrics from last benchmark
    last_results: Vec<SortMetrics>,
}

impl SortCoordinator {
    /// Create a new sort coordinator
    pub fn new() -> Self {
        Self {
    ...
    /// Generate random array with specified size and range
    ...
    /// Generate different types of test arrays for comprehensive testing
    ...
    /// Run comprehensive sorting benchmarks
    pub fn run_benchmarks(&mut self, array_size: usize, iterations: usize) -> Result<Vec<SortMetrics>> {
        ...
        // Test on random array (most common case)
    ...
    fn display_summary_statistics(&self, results: &[SortMetrics]) {
        ...
        // Sort complexities for consistent display order
        let mut complexity_vec: Vec<_> = time_complexities.into_iter().collect();
        complexity_vec.sort_by(|a, b| {
            // Define a custom order for Big O complexities
    ...
    /// Generate performance report for a specific array type
...
/// Calculate theoretical time complexity value
...
/// Classify efficiency based on actual vs theoretical ratio
